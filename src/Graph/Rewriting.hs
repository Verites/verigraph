...
poc m l =
  let ml       = Mor.compose l m                                                         -- compose l and m obtaining ml
      delEdges = mapMaybe (GM.applyEdge $ TGM.mapping m) (TGM.orphanEdgesTyped l) -- obtain list of edges to be deleted in G
      delNodes = mapMaybe (GM.applyNode $ TGM.mapping m) (TGM.orphanNodesTyped l) -- obtain list of nodes to be deleted in G
