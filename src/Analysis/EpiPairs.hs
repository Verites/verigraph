...
createPairs :: GraphMorphism a b -> GraphMorphism a b
     -> [(TypedGraphMorphism a b, TypedGraphMorphism a b)]
createPairs m1 m2 = map (mountTGMBoth m1 m2) (genEqClass (mixTGM m1 m2))

-- | Create all jointly surjective pairs of @m1@ and @m2@
createPairsCodomain :: TypedGraphMorphism a b -> TypedGraphMorphism a b
     -> [(TypedGraphMorphism a b, TypedGraphMorphism a b)]
...
commutingPairs :: TypedGraphMorphism a b -> TypedGraphMorphism a b
     -> [(TypedGraphMorphism a b, TypedGraphMorphism a b)]
