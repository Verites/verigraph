...
{-Functions types changed to GraphRule because criticalSequences just works for it, waiting reunion to fix it-}
...
allConcurrentRules :: CRDependencies -> Bool -> Bool -> [GraphRule a b] -> [GraphRule a b]
...
maxConcurrentRule :: CRDependencies -> Bool -> Bool -> [GraphRule a b] -> GraphRule a b
...
maxConcurrentRules :: CRDependencies -> Bool -> Bool -> [GraphRule a b] -> [GraphRule a b]
