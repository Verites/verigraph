...
createJointlyEpimorphicPairsFromCodomains :: (JointlyEpimorphisms morph) => MorphismType -> morph -> morph -> [(morph,morph)]
createJointlyEpimorphicPairsFromCodomains inj m1 m2 =
  createJointlyEpimorphicPairs (inj == Monomorphism) (codomain m1) (codomain m2)
