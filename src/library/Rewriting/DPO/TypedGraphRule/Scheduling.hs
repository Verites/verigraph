...
asLongAsPossible :: MorphismsConfig -> [Named2Rule a b] -> [NamedRule a b] -> Int -> (String,[NamedRule a b])
...
asLongAsPossible_ :: MorphismsConfig -> [Named2Rule a b] -> [NamedRule a b] -> String -> Int -> (String,[NamedRule a b])
...
getOneMatch :: MorphismsConfig -> [Named2Rule a b] -> [NamedRule a b] -> [NamedRule a b] -> Maybe (RuleMorphism a b, Named2Rule a b, String, [NamedRule a b])
...
getOneMatch_ :: MorphismsConfig -> NamedRule a b -> [Named2Rule a b] -> Maybe (RuleMorphism a b, Named2Rule a b, String)
...
oneStep :: MorphismsConfig -> [Named2Rule a b] -> [NamedRule a b] -> (String,[NamedRule a b])
...
oneStep_ :: MorphismsConfig -> [Named2Rule a b] -> NamedRule a b -> (String,[NamedRule a b])
...
applyAllMatches :: MorphismsConfig -> NamedRule a b -> Named2Rule a b -> (String,[NamedRule a b])
...
specific :: MorphismsConfig -> [Named2Rule a b] -> [NamedRule a b] -> String -> String -> (String,[NamedRule a b])
