module Data.TypedGraph.Morphism.FindMorphismSpec.FindSpanCommuterTest (findSpanCommuterTest) where
...
genericCompare conf morphismOne morphismTwo =
  findSpanCommuters conf morphismOne morphismTwo
...
genericCommuter conf morphismOne morphismTwo = 
  filter commutes $ findMorphisms conf (codomain morphismOne) (codomain morphismTwo)
  where commutes x = x <&> morphismOne == morphismTwo
